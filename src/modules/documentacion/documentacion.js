  ...
  return [
    '<div class="modal" style="max-width:560px;">',
      ...
      '<div class="modal-body">',
        ...
        '<div class="form-grid form-grid-2">',
          '<div class="form-group"><label>Talle de ambo</label><select id="dc-uni-ambo" style="width:100%;padding:8px;border:1px solid #cbd5e1;border-radius:8px;font-size:13px;"><option value="">Seleccionar...</option>' + TALLES_POR_PRENDA.Ambo.map(t => '<option>' + t + '</option>').join('') + '</select></div>',
