...
// La vista de lista plana (renderPreciosUniformes) y su modal contenedor
// (modal-uniformes-precios, botón "Gestionar precios" de Uniformes)
// se eliminaron (14/09) — la gestión de precios vive en Stock → tab
// Precios (grid prenda×mes, renderPreciosUniformesGrid). Este modal de
// alta SIGUE VIGENTE: lo abre "Cargar" desde esa grilla, vía
// abrirNuevoPrecioConVigencia() de abajo.
