...
export function poblarSelects(){
  ...
  // El puesto ahora se elige por línea (ver renderLineasPedido en
  // pedidos.js, v158) — ya no hay un <select> único de puesto acá.
  fillSelect('p-supervisor',nombresSupervisoresReales(),['— Seleccionar —']);fillSelect('p-zona',DB.zonas);
