...
export const DB = {
  ...
  // Gestión de horas (GESTION_HORAS_para_Fede.md) — regla de puestos
  // pactada por servicio, versionada igual que supervisionVigencias:
  ...
  negociaciones: [],
  negociacionesAcciones: [],
  negociacionesGestiones: [],
  negociacionesGestionTipos: [],
  // v097 — Precios LIGE
  preciosObjetivos: [],
  preciosEscalas: [],
  preciosEscalasDetalle: [],
  preciosGrupos: [],
  preciosNotasConfig: [],
  preciosNotasEmitidas: [],
  preciosSnapshots: [],
  preciosSnapshotDetalle: [],
  preciosAplicaciones: [],
  preciosAuditoria: [],
  preciosAuditoriaObjetivos: [],
  sucursales: [],
...
export const PERFILES = {
  'Administrador total': { color: 'badge-rojo', modulos: ['inicio', 'candidatos', 'pedidos', 'psicotecnico', 'preocupacional', 'documentacion', 'altas', 'legajos', 'reasignaciones', 'dotacion', 'legal', 'enfermos', 'capacitaciones', 'vacaciones', 'descansos', 'competencia', 'clientes', 'objetivos', 'precios', 'gestion_horas', 'paritarias', 'categorias', 'crm', 'negociaciones', 'reclamos', 'cobros', 'comisiones', 'supervisores', 'supervision', 'liquidacion', 'resumen_horas', 'feriados', 'liq_admin', 'liquidaciones', 'retenes', 'tareas_especiales', 'mantenimiento', 'configuracion', 'smvm', 'monotributos', 'uniformes', 'stock', 'pedido_productos', 'retenciones', 'descuentos', 'sanciones', 'adelantos', 'pedidos_adelantos', 'gestion_adelantos', 'sugerencias', 'proveedores', 'maquinas', 'cuentas_cbu'], desc: 'Acceso completo.' },
  ...
  'Comercial': { color: 'badge-naranja', modulos: ['inicio', 'clientes', 'objetivos', 'precios', 'gestion_horas', 'supervision', 'crm', 'negociaciones', 'reclamos', 'comisiones', 'sugerencias'], desc: 'Clientes, objetivos, precios, CRM, negociación, reclamos y comisiones.' },
...
export const MENU = [
  ...
  { section: 'Operaciones', items: [
    ...
    { key: 'resumen_horas', icon: '📊', label: 'Resumen de horas', perfiles: ['Administrador total', 'Operaciones', 'Finanzas', 'Supervisor'] },
    { key: 'mantenimiento', icon: '🔧', label: 'Mantenimiento', perfiles: ['Administrador total', 'RRHH', 'Operaciones', 'Finanzas'] },
    { key: 'reasignaciones', icon: '🔄', label: 'Reubicación', badge: 'reas', perfiles: ['Administrador total', 'RRHH', 'Operaciones'] },
    { key: 'gestion_horas', icon: '⏱', label: 'Gestión de horas', perfiles: ['Administrador total', 'Operaciones', 'Comercial', 'Finanzas'] },
    { key: 'dotacion', icon: '👥', label: 'Dotación', perfiles: ['Administrador total', 'RRHH', 'Operaciones'] },
    { key: 'retenes', icon: '🔄', label: 'Retenes', perfiles: ['Administrador total', 'RRHH', 'Operaciones', 'Finanzas'] },
    { key: 'tareas_especiales', icon: '🧰', label: 'Tareas Especiales', perfiles: ['Administrador total', 'RRHH', 'Operaciones', 'Finanzas'] },
  ]},
  { section: 'Comercial', items: [
    ...
    { key: 'negociaciones', icon: '📈', label: 'CRM Negociación', perfiles: ['Administrador total', 'Operaciones', 'Comercial'] },
  ...
  { section: 'Finanzas', items: [
    ...
    // Padrón de cuentas bancarias (ticket "Módulo cuentas bancarias",
    // 16/09) — fuente única del CBU del asociado. RRHH inicia el trámite
    // con el banco, Finanzas carga el CBU; el resto del sistema (legajo)
    // solo lee de acá.
    { key: 'cuentas_cbu', icon: '🏦', label: 'Cuentas CBU', perfiles: ['Administrador total', 'RRHH', 'Finanzas'] },
