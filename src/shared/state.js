...
export const PERFILES = {
  ...
  'Comercial': { color: 'badge-naranja', modulos: ['inicio', 'clientes', 'objetivos', 'precios', 'crm', 'reclamos', 'sugerencias'], desc: 'Clientes, objetivos, precios, CRM y reclamos.' },
