...
export const _SM = {
  ...
  // v096 — Módulo Máquinas
  maquinas: 'maquinas',
  maquinasMovimientos: 'maquinas_movimientos',
  maquinasTickets: 'maquinas_tickets',
  maquinasTicketHistorial: 'maquinas_ticket_historial',
  objetivos: 'objetivos',
...
export function _toSnake(obj) {
  const m = {
    ...
    pedidoVacanteIdx: 'pedido_vacante_idx',
    consultadoAcepta: 'consultado_acepta', consultadoPor: 'consultado_por',
    ...
    // v118 — Pago mensual: desglose completo congelado
    impIntegradoCongelado: 'imp_integrado_congelado', sipaCongelado: 'sipa_congelado',
    obraSocialCongelado: 'obra_social_congelado', iibbCongelado: 'iibb_congelado',
    condicionCongelada: 'condicion_congelada', categoriaCongelada: 'categoria_congelada',
    ...
    coordinadorCuenta: 'coordinador_cuenta', coordinadorCuentaTipo: 'coordinador_cuenta_tipo',
    coordinadorCuentaContacto: 'coordinador_cuenta_contacto', tipoFactura: 'tipo_factura',
    ...
    // v096 — Módulo Máquinas
    nroMaquina: 'nro_maquina', proveedorAlquiler: 'proveedor_alquiler',
    costoAlquilerMensual: 'costo_alquiler_mensual', contratoNro: 'contrato_nro',
    estadoMotivo: 'estado_motivo', servicioCodigo: 'servicio_codigo',
    servicioNombre: 'servicio_nombre', fechaCompra: 'fecha_compra',
    costoCompra: 'costo_compra', vidaUtilMeses: 'vida_util_meses',
    bateriaTipo: 'bateria_tipo', bateriaColocada: 'bateria_colocada',
    bateriaVidaUtil: 'bateria_vida_util', bateriaCosto: 'bateria_costo',
    reparacionesAcum: 'reparaciones_acum', fotoUrl: 'foto_url',
    maquinaIdLocal: 'maquina_id_local', registradoPor: 'registrado_por',
    nroTicket: 'nro_ticket', problemaTipo: 'problema_tipo',
    problemaDesc: 'problema_desc', problemaFotoUrl: 'problema_foto_url',
    reportadoPor: 'reportado_por', reportadoFecha: 'reportado_fecha',
    etapaInicioEn: 'etapa_inicio_en', cerradoEn: 'cerrado_en',
    reemplazoIdLocal: 'reemplazo_id_local', resolucionNotas: 'resolucion_notas',
    proveedorNombre: 'proveedor_nombre', proveedorActa: 'proveedor_acta',
    proveedorActaUrl: 'proveedor_acta_url', facturaMonto: 'factura_monto',
    facturaObservada: 'factura_observada', facturaObsNotas: 'factura_obs_notas',
    costoRepuestos: 'costo_repuestos', costoProveedor: 'costo_proveedor',
    ticketIdLocal: 'ticket_id_local', etapaAnterior: 'etapa_anterior',
    etapaNueva: 'etapa_nueva', trabajoTipo: 'trabajo_tipo',
    actaUrl: 'acta_url',
    // v094 — Proveedores
...
export function _toCamel(obj) {
  const m = {
    ...
    pedido_vacante_idx: 'pedidoVacanteIdx',
    consultado_acepta: 'consultadoAcepta', consultado_por: 'consultadoPor',
    ...
    imp_integrado_congelado: 'impIntegradoCongelado', sipa_congelado: 'sipaCongelado',
    obra_social_congelado: 'obraSocialCongelado', iibb_congelado: 'iibbCongelado',
    condicion_congelada: 'condicionCongelada', categoria_congelada: 'categoriaCongelada',
    ...
    coordinador_cuenta: 'coordinadorCuenta', coordinador_cuenta_tipo: 'coordinadorCuentaTipo',
    coordinador_cuenta_contacto: 'coordinadorCuentaContacto', tipo_factura: 'tipoFactura',
    ...
    // v096 — Módulo Máquinas
    nro_maquina: 'nroMaquina', proveedor_alquiler: 'proveedorAlquiler',
    costo_alquiler_mensual: 'costoAlquilerMensual', contrato_nro: 'contratoNro',
    estado_motivo: 'estadoMotivo', servicio_codigo: 'servicioCodigo',
    servicio_nombre: 'servicioNombre', fecha_compra: 'fechaCompra',
    costo_compra: 'costoCompra', vida_util_meses: 'vidaUtilMeses',
    bateria_tipo: 'bateriaTipo', bateria_colocada: 'bateriaColocada',
    bateria_vida_util: 'bateriaVidaUtil', bateria_costo: 'bateriaCosto',
    reparaciones_acum: 'reparacionesAcum', foto_url: 'fotoUrl',
    maquina_id_local: 'maquinaIdLocal', registrado_por: 'registradoPor',
    nro_ticket: 'nroTicket', problema_tipo: 'problemaTipo',
    problema_desc: 'problemaDesc', problema_foto_url: 'problemaFotoUrl',
    reportado_por: 'reportadoPor', reportado_fecha: 'reportadoFecha',
    etapa_inicio_en: 'etapaInicioEn', cerrado_en: 'cerradoEn',
    reemplazo_id_local: 'reemplazoIdLocal', resolucion_notas: 'resolucionNotas',
    proveedor_nombre: 'proveedorNombre', proveedor_acta: 'proveedorActa',
    proveedor_acta_url: 'proveedorActaUrl', factura_monto: 'facturaMonto',
    factura_observada: 'facturaObservada', factura_obs_notas: 'facturaObsNotas',
    costo_repuestos: 'costoRepuestos', costo_proveedor: 'costoProveedor',
    ticket_id_local: 'ticketIdLocal', etapa_anterior: 'etapaAnterior',
    etapa_nueva: 'etapaNueva', trabajo_tipo: 'trabajoTipo',
    acta_url: 'actaUrl',
    // v089 — Superadmin / empresas cliente
